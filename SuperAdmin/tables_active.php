...
if(isset($_REQUEST['code'])){
  $college_code = $_REQUEST['code'];
  $sql_active = "UPDATE `college_detail` SET `deleted`= 1,`approved`= 0,`deleted_by`= '".$username."'  WHERE id='".$college_code."'";
  $result_active  = mysql_query($sql_active) OR DIE(mysql_error());
  header("location:tables_active.php");
}
          ...
          <div class="row margin-bottom-30">
            <div class="col-md-12">
              <ul class="nav nav-pills">
                ...
                <li class="active"><a href="tables_active.php">Active Users <span class="badge"><?php echo $count_active; ?></span></a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Active Users Table</h4>
                <table class="table table-striped table-hover table-bordered">
                  ...
                  <tbody>
                  <?php while($row_active = mysql_fetch_array($result_active)) { ?>
                    <tr>
                      <td><?php echo $row_active['college_code'];   ?></td>
                      <td><?php echo $row_active['college_name'];   ?></td>
                      <td><?php echo $row_active['college_type'];   ?></td>
                      <td><?php echo $row_active['college_email'];   ?></td>                    
                      <td>
                        <!-- Split button -->
                        <div class="btn-group">
                      ...
                      <td><a href="http://localhost/shashank/SuperAdmin/tables_active.php?code=<?php echo $row_active['id']; ?>" class="btn btn-link">Delete</a></td>
                    </tr>
                    <?php } ?> 
                  </tbody>
                </table>
